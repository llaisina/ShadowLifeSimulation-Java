...
simulation proceeds in ticks, with the tick rate (time between ticks) determined by a commandline parameter. If more than a maximum number of ticks (also determined by a command-line
